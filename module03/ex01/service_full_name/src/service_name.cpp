...
void concat_full_name(const std::shared_ptr<name_services::srv::Name::Request> request,
            std::shared_ptr<name_services::srv::Name::Response> response){
...
int main(int argc, char **argv)
{
  ...
  rclcpp::Service<name_services::srv::Name>::SharedPtr service =
    node->create_service<name_services::srv::Name>("full_name", &concat_full_name);
