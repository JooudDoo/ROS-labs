...
class MythicCarrotBroadcaster : public rclcpp::Node {
public:
    MythicCarrotBroadcaster() : Node("carry_frame_tf2_broadcaster"), point_index(0) {
...
int main(int argc, char * argv[])
{
  ...
  rclcpp::spin(std::make_shared<MythicCarrotBroadcaster>());
  rclcpp::shutdown();
